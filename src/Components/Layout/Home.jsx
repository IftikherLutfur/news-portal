const Home = () => {
        ...
        <div>
            <div className="space-y-12 dark:bg-gray-100 dark:text-gray-800">
                ...
                <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
                    ...
                    <form onSubmit={handleSubmitForRagi} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                placeholder="Name"
                                className="w-full border-2 border-black p-3 rounded dark:bg-gray-100" />
                        </div>
 ...
 <button type="submit" 
 className="w-full p-3 text-sm font-bold tracking-wide uppercase rounded dark:bg-violet-600 dark:text-gray-50">Register</button>
                    </form>
